<?php
    ...
    $config['photo']['photo_static'][$nametype]['width'] =  148;
    $config['photo']['photo_static'][$nametype]['height'] = 148;
    $config['photo']['photo_static'][$nametype]['thumb'] = '148x148x1';
    ...
    $config['photo']['man_photo'][$nametype]['height_photo'] = 608;
    $config['photo']['man_photo'][$nametype]['thumb_photo'] = '1366x608x1';
    ...
    $config['photo']['man_photo'][$nametype]['avatar_photo'] = true;
    $config['photo']['man_photo'][$nametype]['link_photo'] = true;
    $config['photo']['man_photo'][$nametype]['width_photo'] = 36;
    $config['photo']['man_photo'][$nametype]['height_photo'] = 36;
    $config['photo']['man_photo'][$nametype]['thumb_photo'] = '36x36x1';
    $config['photo']['man_photo'][$nametype]['img_type_photo'] = '.jpg|.gif|.png|.jpeg|.gif';

    /* imgabout */
    $nametype = "hinhanh-lienhe";
    $config['photo']['man_photo'][$nametype]['title_main_photo'] = "Hình ảnh liên hệ";
    $config['photo']['man_photo'][$nametype]['check_photo'] = array("hienthi" => "Hiển thị");
    $config['photo']['man_photo'][$nametype]['number_photo'] = 4;
    $config['photo']['man_photo'][$nametype]['images_photo'] = true;
    $config['photo']['man_photo'][$nametype]['avatar_photo'] = true;
    $config['photo']['man_photo'][$nametype]['width_photo'] = 223;
    $config['photo']['man_photo'][$nametype]['height_photo'] = 213;
    $config['photo']['man_photo'][$nametype]['thumb_photo'] = '223x212x1';
    $config['photo']['man_photo'][$nametype]['img_type_photo'] = '.jpg|.gif|.png|.jpeg|.gif';
    ...
    $config['photo']['man_photo'][$nametype]['images_photo'] = true;
    $config['photo']['man_photo'][$nametype]['avatar_photo'] = true;
    $config['photo']['man_photo'][$nametype]['width_photo'] = 488;
    $config['photo']['man_photo'][$nametype]['height_photo'] = 408;
    $config['photo']['man_photo'][$nametype]['thumb_photo'] = '488x408x1';
    $config['photo']['man_photo'][$nametype]['img_type_photo'] = '.jpg|.gif|.png|.jpeg|.gif';
