<?php  
    ...
    $videonb = $cache->get("select link_video,name$lang, id from #_photo where type = ? and find_in_set('noibat',status) and find_in_set('hienthi',status)", array('video'), 'result', 7200);
