        ...
        <div class="row">
            <ol class="breadcrumb float-sm-left">
                ...
                <li class="breadcrumb-item"><a href="<?=$linkMan?>"
                        title="Quản lý <?=$config['newsletter'][$type]['title_main']?>">Quản lý
                        <?=$config['newsletter'][$type]['title_main']?></a></li>
                <li class="breadcrumb-item active"><?=($act=="edit")?"Cập nhật":"Thêm mới";?>
                    <?=$config['newsletter'][$type]['title_main']?></li>
            </ol>
        </div>
    </div>
</section>
            ...
            <div class="card-body">
                    ...
                    <div class="upload-file mb-2">
                        ...
                        <label class="upload-file-label mb-2" for="file_attach">
                            <div class="custom-file my-custom-file">
                                <input type="file" class="custom-file-input" name="file_attach" id="file_attach"
                                    lang="vi">
                                <label class="custom-file-label mb-0" data-browse="Chọn" for="file_attach">Chọn
                                    file</label>
                            </div>
                        </label>
                        ...
                        <div class="file-uploaded mb-2">
                            <a class="btn btn-sm bg-gradient-primary text-white d-inline-block align-middle rounded p-2"
                                href="<?=UPLOAD_FILE.@$item['file_attach']?>" title="Download tập tin hiện tại"><i
                ...
                <div class="form-group-category row">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control text-sm" name="data[fullname]" id="fullname"
                            placeholder="Họ tên"
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="email" class="form-control text-sm" name="data[email]" id="email"
                            placeholder="Email"
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control text-sm" name="data[phone]" id="phone"
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control text-sm" name="data[address]" id="address"
                            placeholder="Địa chỉ"
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control text-sm" name="data[subject]" id="subject"
                            placeholder="Chủ đề"
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <select id="confirm_status" name="data[confirm_status]" class="form-control select2">
                            ...
                            <option
                                <?=(!empty($flashConfirmStatus) && $flashConfirmStatus == $key) ? 'selected' : ((@$item['confirm_status'] == $key) ? 'selected' : '')?>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control text-sm" name="data[content]" id="content" rows="5"
                        placeholder="Nội dung"
                        required><?=(!empty($flash->has('content'))) ? $flash->get('content') : @$item['content']?></textarea>
                </div>
                <?php } ?>
                <?php if(isset($config['newsletter'][$type]['datetime']) && $config['newsletter'][$type]['datetime'] == true) { ?>
                <div class="form-group">
                    <label for="datetime">Ngày đặt bàn:</label>
                    <p><?=date("d/m/Y - h:i:s A", $item['datetime'])?></p>
                </div>
                <?php } ?>
                <div class="form-group">
